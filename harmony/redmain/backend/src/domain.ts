...
export type SummaryFilterCategory = 'all' | 'favorite' | 'tag';
...
export interface SummaryFilter {
  category?: SummaryFilterCategory;
  tag?: string;
  keyword?: string;
