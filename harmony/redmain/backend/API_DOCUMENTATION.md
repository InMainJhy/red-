...
These endpoints are used by the summary list page and summary detail page.
...
```json
{
  ...
  "items": [
    {
      "id": "summary_run-123",
      "title": "Stage Persona Summary",
      "topic": "Should I leave this job?",
      "createdAt": "2026-04-09T03:20:00.000Z",
      "timeAgo": "just now",
      "participantNames": ["Past Me", "Present Me"],
      "participantAvatars": ["P", "P"],
      "avatarColors": ["#FEE2E2", "#DBEAFE"],
      "accentColor": "#FEE2E2",
      "consensusPreview": "Keep the exit option open while...",
      "highlightCount": 3,
      "isFavorite": false,
      "messageCount": 6,
      "duration": 0
...
```json
{
  "record": {
    ...
    "duration": 0,
    "messageCount": 6,
    "consensus": "Keep the exit option open while rebuilding leverage.",
    "disagreements": ["Leave now or wait one quarter."],
    "actionableAdvice": ["Refresh your resume this week."],
    "narrativeHook": "Do not resign from panic; resign from position.",
    "participants": [],
    "highlights": ["Do not resign from panic; resign from position."],
    "tags": [],
    "isFavorite": false,
    "viewCount": 1,
    "exportedAssets": [],
...
Response: same as `GET /api/summaries/:summaryId`.
